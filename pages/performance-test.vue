<template>
  <div
    class="performance-test-page min-h-screen bg-surface-950 text-primary-50 p-8"
      ...
      <div class="mb-8 p-6 bg-surface-900 rounded-xl border border-surface-700">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div class="space-y-2">
            ...
            <p>
              <strong>Performance Class:</strong> <code>{{ performanceClass }}</code>
            </p>
          </div>
        ...
        <div class="space-y-2">
          ...
          <ul class="list-disc list-inside space-y-1 text-sm text-surface-200">
            <li>
              Animations: {{ performanceLevel.enableAnimations ? '✅ Enabled' : '❌ Disabled' }}
            </li>
            <li>
              Backdrop Blur:
              {{ performanceLevel.enableBackdropBlur ? '✅ Enabled' : '❌ Disabled' }}
            </li>
            <li>
              Complex Gradients:
              {{ performanceLevel.enableComplexGradients ? '✅ Enabled' : '❌ Disabled' }}
            </li>
            <li>
              Floating Effects:
              {{ performanceLevel.enableFloatingEffects ? '✅ Enabled' : '❌ Disabled' }}
            </li>
        ...
        <div class="grid grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <p>
              ...
              {{ performanceCSSVars['--perf-animation-duration'] }}
            </p>
          </div>
          <div>
            <p>
              <strong>Max Animations:</strong> {{ performanceCSSVars['--perf-max-animations'] }}
            </p>
      ...
      <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <div class="relative z-10">
              ...
              <p class="text-sm text-surface-200">
                This card should have blur effects on high-performance devices.
              </p>
            </div>
          </div>
          ...
          <div class="test-animation-card p-6 bg-surface-800 rounded-xl">
            ...
            <p class="text-sm text-surface-200">
              This card should have floating animation on high-performance devices.
            </p>
          </div>
        </div>
      </div>
