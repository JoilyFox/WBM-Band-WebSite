      ...
      <div class="relative z-10 max-w-6xl mx-auto mb-4 md:mb-14">
        <div class="grid md:grid-cols-2 gap-y-2 gap-x-8 lg:gap-12">
          ...
          <div class="contact-form-wrapper order-2 md:order-1 gap-y-4 flex flex-col">
            ...
            <!-- Email Contact -->
            <a :href="`mailto:${contactEmail}`" class="info-card info-card-clickable">
...
<style scoped lang="scss">
  ...
  .contacts-bg-section {
    ...
    background:
      ...
      /* reversed vertical fade - lighter to darker */
        linear-gradient(
          140deg,
  ...
  @media (hover: hover) and (pointer: fine) {
    ...
    .social-link-item:hover .social-icon-wrapper {
      background: var(
        --brand-color,
        linear-gradient(135deg, rgba(147, 51, 234, 0.4), rgba(79, 70, 229, 0.3))
      );
