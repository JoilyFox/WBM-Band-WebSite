...
| 5   | `transport_type` passed as an **event param** (not real beacon) ⇒ distributor pre-save conversion may be lost on unload                                                                              | high     | **verify in DebugView (step 8), then fix** — no active distributor pre-save to test yet                                                                                        |
